...
## First Batch Targets (Ready for outreach once domain verified)

### 1. Buttondown (Email) ✓ READY
**Founder:** Justin Duke (solo founder)
**Contact:** support@buttondown.com
**Category:** email
**Website:** https://buttondown.com
**Research completed:** Yes - former Stripe engineer, $15k MRR, patience-focused growth, anti-VC
**Angle:** Insider (founder-to-founder)
**Principle:** Unity + Liking
**Email draft:** See `outreach-drafts/buttondown-justin.md`

### 2. Tally (Productivity) ✓ READY
**Founders:** Marie Martens & Filip Minev
**Contact:** hello@tally.so
**Category:** productivity
**Website:** https://tally.so
**Research completed:** Yes - Ghent Belgium, $4M ARR, "small by design" philosophy, competes with Typeform
**Angle:** Insider (fellow bootstrappers)
**Principle:** Unity + Reciprocity
**Email draft:** See `outreach-drafts/tally-marie-filip.md`

### 3. Plausible (Analytics) - SKIPPED
**Reason:** Too successful ($188k/mo). Won't care about €39/mo featured listing.
**Alternative:** Consider smaller analytics tools if adding more
...
|------|---------|-------|-----------|
| Buttondown | support@buttondown.com | Insider (founder-to-founder) | Unity + Liking |
| Tally | hello@tally.so | Fellow bootstrappers | Unity + Reciprocity |
| Crisp | contact@crisp.chat | David vs Goliath (vs Intercom) | Unity + Authority |
| Fathom | jack@usefathom.com | Solo founder respect | Unity + Liking |
